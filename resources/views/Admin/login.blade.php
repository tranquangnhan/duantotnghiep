            ...
            <div class="col-md-8 col-lg-6 col-xl-5">
                <div class="text-center">
                    <a href="index.html" class="logo">
                        <img src="{{asset('admin/images/logo-light.png')}}" alt="" height="22" class="logo-light mx-auto">
                        <img src="{{asset('admin/images/logo-dark.png')}}" alt="" height="22" class="logo-dark mx-auto">
                    </a>
                ...
                <div class="card">
                    ...
                    <div class="card-body p-4">
                        ...
                        <form method="POST" id="formlogin" action="{{URL::to('/admin/dangnhapadmin')}}" data-parsley-validate novalidate>
                            @csrf
